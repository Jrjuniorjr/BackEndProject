...
public class ConfiguracaoPermissaoService {
	...
	public ResponseEntity adicionarPermissao(ConfiguracaoPermissaoFormatoEnvio permissaoObject) {
		Operador operador = operadorService.consultarOperadorPorCodigo(permissaoObject.getCodigoOperador());
		Operador administrador = operadorService.consultarOperadorPorCodigo(permissaoObject.getCodigoAdministrador());
